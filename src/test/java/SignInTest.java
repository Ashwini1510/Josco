...
public class SignInTest {
 ...
 @Test
  ...
  @Test
  public void testJoscoTestCase2() throws Exception {
    driver.get("https://www.jewelosco.com/");
    driver.findElement(By.linkText("Shop")).click();
    driver.findElement(By.xpath("//div[@id='shopFlyOutModal']/div/div/div/nav/div/ul/span/li[8]/span")).click();
    driver.findElement(By.linkText("Cereal")).click();
    driver.findElement(By.id("pg970098247")).click();
    driver.findElement(By.id("addButton_970098247")).click();
  }
 @Test
